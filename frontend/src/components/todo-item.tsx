    ...
    >
      {isEditing ? (
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <label htmlFor={`edit-desc-${todo.id}`} className="block text-sm font-medium text-gray-700">
              Descrição
            </label>
            <textarea
          ...
          <div className="flex justify-end space-x-2">
            <button
              ...
              disabled={isUpdating}
              className="flex items-center px-3 py-2 text-sm border rounded-md hover:bg-gray-100 disabled:opacity-50"
            >
        ...
        <div className="flex justify-between items-start">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              {todo.description && (
                <p className={`text-sm ${todo.completed ? "line-through text-gray-300" : "text-gray-600"}`}>
                  {todo.description}
                </p>
              )}
            </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center justify-center rounded-md w-9 h-9 text-gray-500 hover:bg-gray-100 hover:text-primary transition-colors disabled:opacity-50"
              aria-label="Editar"
            >
            ...
            <button
              ...
              disabled={isDeleting || isToggling}
              className="flex items-center justify-center rounded-md w-9 h-9 text-gray-500 hover:bg-red-50 hover:text-red-600 transition-colors disabled:opacity-50"
              aria-label="Excluir"
            >
              {isDeleting ? (
